...
public class ShadowActivityThreadTest {
  ...
  @Test
  public void currentActivityThread_LazyInitialization() {
    assertThat(RuntimeEnvironment.getActivityThread(false)).isNull();
    assertThat(ShadowActivityThread.currentActivityThread()).isNotNull();
  }

  @LazyLoadApplication(LazyLoad.ON)
  @Test
  public void currentApplication_LazyInitialization() {
